...
public class PersonSelectorComponent extends CustomComponent {
	...
	public PersonSelectorComponent() {
		...
		searchResult.addColumn(Person::getDisplayName).setCaption(I18n.getText(getI18nBase() + ".property.displayName"));
	...
	private void initActiveInactive() {
		if (useActiveInactive) {
			...
			activeInactive.setItemCaptionGenerator(ACTIVE_INACTIVE::getText);
	...
	private HorizontalLayout buildFilterLayout() {
		...
		errorLabel.setValue("Label");
		filterLayout.addComponent(errorLabel);
	...
	private VerticalLayout buildFormLayout() {
		...
		formLayout.addComponent(department);
	...
	private VerticalLayout buildSearchLayout() {
		...
		searchLayout.setComponentAlignment(searchButton, new Alignment(9));
	...
	private VerticalLayout buildResultLayout() {
		...
		resultLayout.addComponent(searchResult);
		resultLayout.setExpandRatio(searchResult, 1.0f);
	...
	private HorizontalLayout buildButtonLayout() {
		...
		UIHelper.setImmediate(detailsButton, true);
