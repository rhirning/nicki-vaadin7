...
public class ProjectViewer extends VerticalLayout implements ClassEditor {
	...
	public ProjectViewer() {
		buildMainLayout();
		// Project main data
		tabSheet.addTab((Component) dataView, I18n.getText("nicki.editor.projects.tab.data.title"), VaadinIcon.USERS);
	}
